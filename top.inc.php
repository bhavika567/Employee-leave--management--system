         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <h1 class="navbar-brand" href="index.php"><i class="fa fa-calendar" style="font-size:18px;color:white"></i>ELMS</h1>
                  <!-- <a class="navbar-brand hidden" href="index.php"><h3>ELMS</h3></a> -->
